#!/bin/bash
# Train one LoRA r128 run at a given LR, then run eval_and_log.sh on the ckpt.
# Mirrors run_fura_sweep_one.sh for the LoRA arm of the LR sweep.
#
# Required env: LR, DEVICE
# Optional env:
#   RUN_NAME                  (default: lora-r128-lr${LR})
...
RUN_NAME="${RUN_NAME:-lora-r128-lr${LR}}"
