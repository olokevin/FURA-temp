...
parser.add_argument('--quantization', type=str, default=None, help="vLLM quantization, e.g. 'bitsandbytes'")
parser.add_argument('--gpu_memory_utilization', type=float, default=0.9, help="")
parser.add_argument('--max_model_len', type=int, default=None, help="")
...
if args.quantization:
    ...
    # bitsandbytes needs the load format set explicitly to find pre-quantised
    # safetensors or to quantise on the fly from a bf16 checkpoint.
