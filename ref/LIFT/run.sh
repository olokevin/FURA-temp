...
# CUDA_VISIBLE_DEVICES=7 lr=1e-4 bash bash_scripts/finetune_commonsense_lora.sh
# CUDA_VISIBLE_DEVICES=2 lr=1e-5 bash bash_scripts/finetune_commonsense_full.sh
...
CUDA_VISIBLE_DEVICES=5 lr=1e-4 decomp_mode=output_one_block s_merged_to=keep_trainable bash bash_scripts/finetune_commonsense_blocktt.sh


# CUDA_VISIBLE_DEVICES=5 lr=1e-5 decomp_mode=output_one_block s_merged_to=keep_trainable train_position=both bash bash_scripts/finetune_commonsense_blocktt.sh

# CUDA_VISIBLE_DEVICES=4 lr=2e-5 decomp_mode=input_one_block calib_mode=v2 s_merged_to=keep_trainable bash bash_scripts/finetune_commonsense_blocktt.sh >/dev/null 2>&1 &
...
# /data/yequan/fura/lift/commonsense/meta-llama/Meta-Llama-3-8B/blocktt-lr_2e-4-decomp_output_one_block_pos_small_smerge_trainable-seed_43
...
# /data/yequan/fura/lift/commonsense/meta-llama/Meta-Llama-3-8B/blocktt-calib_v2_bp-lr_2e-5-decomp_output_one_block_pos_small_smerge_keep_trainable-seed_43
...
# CUDA_VISIBLE_DEVICES=3 bash bash_scripts/eval_commonsense.sh base_model=meta-llama/Meta-Llama-3-8B CKPT=/data/yequan/fura/lift/commonsense/meta-llama/Meta-Llama-3-8B/blocktt-lr_2e-4-decomp_output_one_block_pos_small_smerge_trainable-seed_43 >/dev/null 2>&1 &
...
### lr search
# CUDA_VISIBLE_DEVICES=1 lr=1e-4 decomp_mode=output_one_block s_merged_to=keep_trainable bash bash_scripts/finetune_math_blocktt.sh >/dev/null 2>&1 &
# CUDA_VISIBLE_DEVICES=0 lr=2e-4 decomp_mode=output_one_block s_merged_to=keep_trainable bash bash_scripts/finetune_math_blocktt.sh >/dev/null 2>&1 &

### 
# CUDA_VISIBLE_DEVICES=1 lr=2e-5 decomp_mode=output_one_block calib_mode=v2_bp s_merged_to=keep_trainable bash bash_scripts/finetune_math_blocktt.sh
# CUDA_VISIBLE_DEVICES=1 lr=5e-5 decomp_mode=output_one_block calib_mode=v2_bp s_merged_to=keep_trainable bash bash_scripts/finetune_math_blocktt.sh
# CUDA_VISIBLE_DEVICES=1 lr=3e-4 decomp_mode=output_one_block s_merged_to=keep_trainable bash bash_scripts/finetune_math_blocktt.sh
