...
OUTPUT=${OUTPUT_SRC_DIR}/math/${MODEL}/qfura-layout_${quant_block_layout}-decomp_${decomp_mode}_smerge_${s_merged_to}-lr_${lr}-seed_${seed}
...
# Skip eval for smoke tests (MAX_STEPS > 0).
if [ "${MAX_STEPS}" = "0" ]; then
