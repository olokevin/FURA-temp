#!/bin/bash
# Group B2: Llama-3.2-3B -> ~2B via svd_llm_v2_combined, then full FT on MATH-10K, eval gsm8k.
# Launch with: DEVICE=N bash bash_scripts/finetune_math_full_b2_svd_v2_combined_2b.sh
