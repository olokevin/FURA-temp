...
usage() {
    echo "Usage: bash bash_scripts/eval_commonsense_lora.sh CKPT=<model_checkpoint_path> [adapter_name=<name>] [base_model=<hf_model>] [wandb_project=<project>] [wandb_run_name=<name>] [wandb_run_id=<id>]"
}
