#!/bin/bash
# Full FT 1-epoch commonsense_170k, lr=7e-6, seed=43, eval = boolq + openbookqa only.

set -u

PROJECT_DIR="/home/yequan/Project/lora/lora-without-regret"
LAUNCH_LOG="/data/yequan/fura/lift/launch_logs/gpu6_full_1ep_lr7e-6.log"
...
echo "=== [GPU6] full lr=${LR} 1ep seed=${SEED} @ $(date) ===" >> "$LAUNCH_LOG"
