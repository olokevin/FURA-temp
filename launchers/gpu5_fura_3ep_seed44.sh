#!/bin/bash
# fura/blocktt 3-epoch commonsense_170k, lr=2e-4, seed=44, full 8-task eval.
...
LAUNCH_LOG="/data/yequan/fura/lift/launch_logs/gpu5_fura_3ep_seed44.log"
...
echo "=== [GPU5] fura 3ep lr=${LR} seed=${SEED} @ $(date) ===" >> "$LAUNCH_LOG"
